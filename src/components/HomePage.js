...
const HomePage = () => {
  return (
    <div className='flex w-[100vw] h-[100vh]'>
          <div className='flex flex-col bg-gradient-to-r from-neutral-800 lg:pl-0 pl-20 to bg-black lg:w-[50vw] w-[100vw] h-[100vh]'>
              <div className='flex flex-col lg:w-[70%] w-[90%] h-[100%] m-auto text-start mt-20'>
                  <h1 className='text-white text-[30px] pt-10 pb-10'>
                      @ ColdnBrew.
                  </h1>
                  <h1 className='text-white lg:text-[70px] text-[50px] w-[70%] pt-20 font-bold'>Chose Your Coffee Maker With CnB.</h1>
                  {/* <h1 className='text-orange-500 text-[80px] font-bold'>.</h1> */}
              <p className='pt-10 pb-10 text-neutral-500 border-b w-[85%] lg:text-[30px] text-[20px]'> Buy the best premium coffee makers</p>
