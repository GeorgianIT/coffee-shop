  ...
  return (
    ...
    animate={control} className='flex m-auto lg:w-[80%] xl:w-[60%] w-[90%] flex-col text-start mt-20 mb-20 text-black m-auto'>
        <div className='flex justify-between pb-10 flex-col'>
              <h1 className='text-[40px] m-auto lg:w-[80%] xl:w-[45%] w-[90%]'>Our Blogs Coffe with trending topic for this week</h1>
              <div className='flex m-auto lg:w-[80%] xl:flex-row flex-col gap-20 mt-20 '>
                    <div className='bg-neutral-200 hover:scale-[105%] p-10 rounded-xl'>
                      <img src={coffeeBlog} className='xl:w-[580px] xl:h-[290px] object-cover rounded-xl '/>
